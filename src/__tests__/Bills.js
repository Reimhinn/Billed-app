...
describe("Given I am connected as an employee", () => {
  describe("When I am on Bills Page", () => {
    ...
    test("if error message appear when the tickets can't be displayed", () => {
...
describe("When employee clicks on eye-icon " , () =>{
     ...
     test("if the modal display the attached image", () => {
      document.body.innerHTML = BillsUI({ data: bills })
      const nBills = new Bills({ document, onNavigate, firestore: null, localStorage: window.localStorage })
...
describe("When I click on New bill button", () => {
  it("it should render NewBill page", () => {
